...
const CollectionForm: React.FC<CollectionFormProps> = ({ collectionId, onSuccess, onCancel }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8 max-h-[90vh] overflow-y-auto">
      <h2 className="text-xl sm:text-2xl font-semibold mb-6 text-gray-900">{isEditMode ? 'تعديل المجموعة' : 'إضافة مجموعة جديدة'}</h2>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-gray-700 text-sm font-semibold mb-2">المجموعة الرئيسية (اختياري)</label>
          <select
          ...
          <p className="text-xs text-gray-500 mt-1">اختر مجموعة رئيسية لإنشاء مجموعة فرعية</p>
        </div>

        <div>
          <label className="block text-gray-700 text-sm font-semibold mb-2">صورة المجموعة</label>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder={collection.name || 'عنوان الميتا للمجموعة'}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none"
                placeholder="https://example.com/collection-url"
              />
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center sm:justify-end gap-3 sm:gap-4 pt-6 border-t border-gray-200">
          ...
          >
            {loading ? (
              ...
              isEditMode ? 'تحديث المجموعة' : 'إنشاء مجموعة'
            )}
          </button>
        </div>
      </form>
